...
public final class LoyaltyDtos {
    ...
    public record CategoryInsightDto(String category, int purchaseCount, BigDecimal spent) {}
    public record PurchaseProfileDto(List<CategoryInsightDto> favoriteCategories, int purchaseCount, BigDecimal totalSpent, String lastPurchaseAt) {}
}
